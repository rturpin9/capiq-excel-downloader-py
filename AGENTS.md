...
**Pro plugin docs:** `C:\Codex\Pro_plugin_documentation\` (Tech Guide + User Guide PDFs)
...
.Codex/skills/comps/SKILL.md    # /comps skill definition
.Codex/skills/chart/SKILL.md    # /chart skill definition
```
...
# CLI — analysis commands (used by Codex skills/subagents)
...
- `capiq_excel/engines/` exposes `comps`, `chart`, and `id_lookup` engines, used by the `capiq` CLI and Codex skills
...
- Skills in `.Codex/skills/comps/SKILL.md` and `.Codex/skills/chart/SKILL.md`
